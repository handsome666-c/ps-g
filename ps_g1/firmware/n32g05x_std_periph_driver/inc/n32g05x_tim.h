...
#ifndef __N32G05X_TIM_H
#define __N32G05X_TIM_H
...
/** TIM Init structure definition is used with all TIMx except for TIM6. **/
typedef struct
{
    ...
    uint32_t CapCh1Sel;         /* Channel 1 select capture in: 
                                   TIM1: TIM1CAPIOM, TIM1CAPCOMP.
                                   TIM2/3/4/5: TIMXCAPIOM, TIMXCAPCOMP, TIMXCAPHSI. */

    uint32_t CapCh2Sel;         /* Channel 2 select capture in: 
                                   TIM2/3/4/5: TIMXCAPIOM, TIMXCAPCOMP. */

    uint32_t CapCh3Sel;         /* Channel 3 select capture in: 
                                   TIM2/3/4/5: TIMXCAPIOM, TIMXCAPCOMP, TIMXCAPLSI. */

    uint32_t CapCh4Sel;         /* Channel 4 select capture in: 
                                   TIM2/3/4/5: TIMXCAPIOM, TIMXCAPCOMP, TIMXCAPHSEDIV128. */

    uint32_t CapEtrClrSel;      /* Etr Clearref select capture in: 
                                   TIM1/2/3/4/5: TIMXCAPETR, TIMXCAPCOMP. */
...
typedef struct
{
    ...
    uint32_t LOCKUPBreak;       /* Specifies whether the LockUp(Core Hardfault) as Break input is enabled or not.
                                                                 This parameter can be a value of Enable or disable */
                                                                 
    uint32_t PVDBreak;          /* Specifies whether the PVD as Break input is enabled or not.
                                                                 This parameter can be a value of Enable or disable */
                                                                 
    uint32_t IOMBreak;          /* Specifies whether the IOM as Break input is enabled or not.
                                                                 This parameter can be a value of Enable or disable */
                                                                 
    uint32_t COMPBreak;         /* Specifies whether the COMP as Break input is enabled or not.
                                                                 This parameter can be a value of Enable or disable */
...
#define TIM_CAPCH1SEL_TIM1CAPIOM           (TIM_REG_BIT_MASK) 
#define TIM_CAPCH1SEL_TIM1CAPCOMP          (TIM_CTRL1_C1SEL) 
#define TIM_CAPCH1SEL_TIMXCAPIOM           (TIM_REG_BIT_MASK) 
#define TIM_CAPCH1SEL_TIMXCAPCOMP          (TIM_INSEL_C1SEL) 
#define TIM_CAPCH1SEL_TIMXCAPHSI           (TIM_CTRL1_C1SEL) 

#define TIM_CAPCH2SEL_TIMXCAPIOM           (TIM_REG_BIT_MASK) 
#define TIM_CAPCH2SEL_TIMXCAPCOMP          (TIM_INSEL_C2SEL) 

#define TIM_CAPCH3SEL_TIMXCAPIOM           (TIM_REG_BIT_MASK) 
#define TIM_CAPCH3SEL_TIMXCAPCOMP          (TIM_INSEL_C3SEL) 
#define TIM_CAPCH3SEL_TIMXCAPLSI           (TIM_CTRL1_C3SEL) 

#define TIM_CAPCH4SEL_TIMXCAPIOM           (TIM_REG_BIT_MASK) 
#define TIM_CAPCH4SEL_TIMXCAPCOMP          (TIM_INSEL_C4SEL) 
#define TIM_CAPCH4SEL_TIMXCAPHSEDIV128     (TIM_CTRL1_C4SEL) 

#define TIM_CAPETRSEL_TIMXCAPETR           (TIM_REG_BIT_MASK) 
#define TIM_CAPETRSEL_TIMXCAPCOMP          (TIM_CTRL1_CLRSEL) 
...
/** LOCKUP as brake input **/
#define TIM_BREAK_LOCKUP_ENABLE             (TIM_CTRL1_LBKPEN)
#define TIM_BREAK_LOCKUP_DISABLE            (TIM_REG_BIT_MASK)

/** PVD as brake input **/
#define TIM_BREAK_PVD_ENABLE                (TIM_CTRL1_PBKPEN)
#define TIM_BREAK_PVD_DISABLE               (TIM_REG_BIT_MASK)

/** IOM as brake input **/
#define TIM_BREAK_IOM_ENABLE                (TIM_CTRL1_IOMBKPEN)
#define TIM_BREAK_IOM_DISABLE               (TIM_REG_BIT_MASK)

/** COMP as brake input **/
#define TIM_BREAK_COMP_ENABLE               (TIM_CTRL1_COMPBKPEN)
#define TIM_BREAK_COMP_DISABLE              (TIM_REG_BIT_MASK)
...
#define TIM_EXT_CLK_SRC_TI1                (TIM_SMCTRL_TSEL_0 | TIM_SMCTRL_TSEL_2)
#define TIM_EXT_CLK_SRC_TI2                (TIM_SMCTRL_TSEL_1 | TIM_SMCTRL_TSEL_2)
